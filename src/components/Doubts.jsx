  ...
  return (
    <div className="font-poppins ">
      {doubtsData.map((doubt) => (
        <div
          key={doubt.id}
          className="border rounded-lg border-2 border-gray-400 h-20 sm:h-20 md:h-24 lg:h-28 flex flex-col md:flex-row justify-center md:justify-between md:items-center mb-4"
        >
